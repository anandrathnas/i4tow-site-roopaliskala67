 ...
 */
export function Reveal({ children, delay = 0, as: Tag = 'div' }: { children: ReactNode; delay?: number; as?: keyof JSX.IntrinsicElements }) {
  ...
  // @ts-expect-error — generic intrinsic tag with ref + data attr
